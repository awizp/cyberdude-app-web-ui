import { type SlideConfig } from "@/app/experiment/get-started/data/slideData";
...
const OnboardingSlide = ({ slide, data, onSelect, direction }: OnboardingSlideProps) => {
  const animClass =
              ...
              >
                ...
                <h3
                  className={`font-display text-base font-semibold mb-1 transition-colors ${
                    isSelected ? "text-orange-500" : "text-foreground group-hover:text-orange-500"
                  }`}
                >
                  {option.label}
                </h3>
