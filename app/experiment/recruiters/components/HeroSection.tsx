...
const HeroSection = () => {
    ...
    const pointsData = ["Live Learning Data", "Behavioral Metrics", "Project Evidence"];
        ...
        <section className="relative min-h-screen flex items-center justify-center px-6 md:px-12 overflow-hidden">
            ...
            <div className="relative max-w-3xl mx-auto text-center">
                ...
                <p className="text-muted-foreground/60 text-sm max-w-md mx-auto mb-12">
                    Live learning data, behavioral metrics, and project evidence in one unified ecosystem.
                </p>
