...
const OnboardingHero = ({ onStart }: OnboardingHeroProps) => {
  return (
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 h-150 rounded-full bg-orange-500/5 blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 text-center">
        ...
        <h1 className="font-display text-5xl md:text-7xl font-bold tracking-tight mb-6 text-foreground">
          Start Your Journey <span className="custom-gradient">in Seconds</span>
        </h1>

        <p className="text-lg text-muted-foreground max-w-lg mx-auto mb-4">
          Tell us a few things about you, and we&apos;ll set up your experience
          instantly.
        </p>
